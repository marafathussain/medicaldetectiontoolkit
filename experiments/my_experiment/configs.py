...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.pp_dir = '/home/marafath/scratch/kits/train'
        self.target_spacing = (1.6, 1.6, 3.0)
        ...
        self.pp_data_path = '/home/marafath/scratch/kits/{}'.format(self.pp_name)
        ...
        self.class_dict = {1: 'kidney'}  # 0 is background.
        self.patient_class_of_interest = 2  # patient metrics are only plotted for one class.
        self.ap_match_ious = [0.1]  # list of ious to be evaluated for ap-scoring.

        self.model_selection_criteria = ['kidney_ap'] # criteria to average over for saving epochs.
